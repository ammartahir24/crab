...
tc class add dev lan1 parent 1: classid 1:10 htb rate 30mbit
tc class add dev lan1 parent 1:10 classid 1:11 htb rate 25mbit ceil 30mbit quantum 7500
tc class add dev lan1 parent 1:10 classid 1:12 htb rate 5mbit ceil 30mbit quantum 1500

tc qdisc add dev lan1 parent 1:11 bfifo limit 384000
tc qdisc add dev lan1 parent 1:12 bfifo limit 384000
